...
public class ModelLoader {
    ...
    void init() throws IOException {
        ...
        glfwSetFramebufferSizeCallback(window, fbCallback = new GLFWFramebufferSizeCallback() {
            ...
            public void invoke(long window, int width, int height) {
                if (width > 0 && height > 0 && (ModelLoader.this.fbWidth != width
        ...
        glfwSetWindowSizeCallback(window, wsCallback = new GLFWWindowSizeCallback() {
            @Override
            public void invoke(long window, int width, int height) {
                if (width > 0 && height > 0 && (ModelLoader.this.width != width
    ...
    void loadModel() {
        ...
        AIScene scene = aiImportFileEx("resources/magnet.obj",
    ...
    static int createShader(String resource, int type) throws IOException {
        ...
        ByteBuffer source = IOUtil.ioResourceToByteBuffer(resource, 1024);
        PointerBuffer strings = BufferUtils.createPointerBuffer(1);
        IntBuffer lengths = BufferUtils.createIntBuffer(1);
        strings.put(0, source);
        lengths.put(0, source.capacity());
    ...
    void createProgram() throws IOException {
        ...
        int vertexShader = createShader("resources/shaders/assimp.vert",
                GL_VERTEX_SHADER_ARB);
        int fragmentShader = createShader("resources/shaders/assimp.frag",
